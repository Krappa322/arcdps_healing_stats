...
struct HealEvent
{
	...
	const bool IsBarrier = false;

	HealEvent(uint64_t pTime, uint64_t pSize, uintptr_t pAgentId, uint32_t pSkillId, bool pIsBarrier);
...
public:
	...
	void BarrierEvent(cbtevent* pEvent, uintptr_t pDestinationAgentId);
