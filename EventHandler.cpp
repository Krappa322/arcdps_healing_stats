...
EventHandler::EventHandler(const CombatCallbackSignature pCallback)
	: mCallback(pCallback)
{
...
uintptr_t EventHandler::ProcessEvent(cbtevent* pEvent, ag* pSourceAgent, ag* pDestinationAgent, const char* pSkillname, uint64_t pId, uint64_t pRevision)
{
...
bool EventHandler::QueueIsEmpty()
{
...
void EventHandler::TryFlushEvents()
{
